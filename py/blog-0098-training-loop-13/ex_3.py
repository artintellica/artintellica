...
losses_batch_noisy = train_batch(X_noisy, y_noisy, epochs=50, lr=0.05)
losses_sgd_noisy = train_stochastic(X_noisy, y_noisy, epochs=50, lr=0.005)
losses_minibatch_noisy = train_minibatch(
    X_noisy, y_noisy, batch_size=16, epochs=50, lr=0.01
)
