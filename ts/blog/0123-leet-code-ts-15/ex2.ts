...
console.log(maxProfit2([7, 1, 5, 3, 6, 4])); // Output: 5 (buy at 1, sell at 6)
console.log(maxProfit2([7, 6, 4, 3, 1])); // Output: 0 (no profit possible)
console.log(maxProfit2([1, 2])); // Output: 1 (buy at 1, sell at 2)
console.log(maxProfit2([2])); // Output: 0 (can't sell)
